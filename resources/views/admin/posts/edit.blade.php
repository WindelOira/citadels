    ...
    <div class="col-lg-9 col-md-12">
      <div class="card card-small mb-3">
        <div class="card-body">
            ...
            {{ Form::bsEditor('content', $post->content) }}
        </div>
      </div>
    </div>
        ...
        <div class="card-header border-bottom">
          <div class="uploader-result">
            <div class="uploader-preview">
              <div class="rounded uploader-preview__image" @if( $post->featured_image ) style="background-image:url({{ url(Storage::url($post->featured_image[0]->thumbnail)) }})" @endif>
              </div>
            </div>
